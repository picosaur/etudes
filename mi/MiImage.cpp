...
void Image::loadTexture() {
  ...
  glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, impl_->width, impl_->height, 0,
               GL_RGBA, GL_UNSIGNED_BYTE, impl_->rgba);
}

void Image::freeTexture() { glDeleteTextures(1, &impl_->textureId); }
} // namespace Mi